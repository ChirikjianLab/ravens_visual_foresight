...
def ResNet36_4s_latent(input_shape,  # pylint: disable=invalid-name
                latent_shape,
                output_dim,
                include_batchnorm=False,
                batchnorm_axis=3,
  ...
  action_input_data = tf.keras.layers.Input(shape=latent_shape)
  x = tf.keras.layers.concatenate([x, action_input_data], axis=3)
  ...
  return [input_data, action_input_data], output